...
persona_IP=['192.168.1.27','192.168.1.6'] #IP address of smartphone; fixed assignment by router
persona_BT=['FC:E9:98:A4:8C:B8','00:00:00:00:00:00'] #BT mac address of smartphone
...
show_keyboard = {'keyboard': [['/now','/casa'], ['/ho_caldo','/ho_freddo'],['/pulizie','/apri']]} #tastiera personalizzata
